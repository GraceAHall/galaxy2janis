...
from fileio.text.tool.ToolOutputRender import ToolOutputRender
...
@dataclass
class ToolOutputSectionRender(TextRender):
    ...
    def imports(self) -> list[Tuple[str, str]]:
        ...
        for out in self.entity:
            imports += ToolOutputRender(out).imports

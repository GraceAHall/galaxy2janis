...
from gx.interaction.mock import MockApp, ComputeEnvironment
from gx.interaction.cmdstrings.jobs.JobFactory import JobFactory
...
class TestCommandLoader:
    ...
    """
    def __init__(self, app: MockApp, history: History, gxtool: GxTool, toolrep: XMLToolDefinition):
        self.app = app

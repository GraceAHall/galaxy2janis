...
import gx.interaction.cmdstrings.dataset_utils as dataset_utils
...
class JobFactory:
    ...
    def __init__(self, app: MockApp, history: History, test: ToolTestDescription, xmltool: XMLToolDefinition):
        self.app = app

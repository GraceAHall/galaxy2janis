...
w.step(
	...
	fastqc(
		...
		option_f="fastq",                                   # -f [String] [GALAXY DEFAULT]
		outdir="/tmp/tmpepp0fozl/working/dataset_3_files",  # --outdir [String] [GALAXY DEFAULT]
	)
)
...
w.step(
	...
	fastqc(
		...
		kmers=7,                                            # --kmers [Int] [GALAXY DEFAULT]
		option_f="fastq",                                   # -f [String] [GALAXY DEFAULT]
		outdir="/tmp/tmp4bzmn352/working/dataset_3_files",  # --outdir [String] [GALAXY DEFAULT]
	)
)
